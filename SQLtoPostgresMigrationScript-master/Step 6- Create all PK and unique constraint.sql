...
-- из выборки исключены таблицы HumanResources.Employee, Production.Document, Production.ProductDocument
-- первичные ключи для них созданы в скрипте "Step 4.5- Form a hierarchical ltree structures.sql"
...
declare CursorIndex cursor for
 ...
 and t.is_ms_shipped=0 and t.name not in ('sysdiagrams', 'Employee', 'Document', 'ProductDocument') 
