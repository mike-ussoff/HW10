...
----- исключим один внешний ключ чтобы пересоздать его в следующем "Step 7.5- Сreate a foreign key for the modified table.sql"
where name <> 'FK_ProductDocument_Document_DocumentNode'
--------------------------------------------------------------------
